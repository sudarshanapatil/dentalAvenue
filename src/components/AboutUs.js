...
function AboutUs () {
  return (
    <Container fluid>
      ...
      <hr></hr>
      <Row className='aboutText'>We are team of doctors helping the people to get best of dental treatment and help you kepp smiling!</Row>
      <Row>
        {drArr.map(key => (
